    ...
    <div  className='  flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400' >
        ...
        <div className=' flex items-center gap-4'>
           ...
           <img onClick={()=>setShowMenu(true)} className='w-6 md:hidden' src={assets.menu_icon} alt="" />
            ...
            <div className={` ${showMenu ? 'fixed w-full h-full  ' : 'hidden'} md:hidden  right-0 top-0 bottom-0 z-0 overflow-hidden bg-white transition-all duration-300 `}>
            ...
            <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
              ...
              <NavLink className='px-4 py-2 rounded  inline-block'  onClick={()=>setShowMenu(false)} to='/doctor'><p>Doctors</p></NavLink>
